...
<body>
					...
					<li id="header_inbox_bar" class="dropdown"><a
						...
						<ul class="dropdown-menu extended inbox">
							...
							<li><a href="index.html#"> <span class="photo"><img
										alt="avatar"
										src="${pageContext.request.contextPath}/assets/img/ui-zac.jpg"></span>
							...
							<li><a href="index.html#"> <span class="photo"><img
										alt="avatar"
										src="${pageContext.request.contextPath}/assets/img/ui-divya.jpg"></span>
							...
							<li><a href="index.html#"> <span class="photo"><img
										alt="avatar"
										src="${pageContext.request.contextPath}/assets/img/ui-danro.jpg"></span>
							...
							<li><a href="index.html#"> <span class="photo"><img
										alt="avatar"
										src="${pageContext.request.contextPath}/assets/img/ui-sherman.jpg"></span>
		...
		<aside>
			<div id="sidebar" class="nav-collapse ">
				...
				<ul  class="sidebar-menu" id="nav-accordion">
					...
					<c:forEach items="${user.categories }" var="c">
						<li class="sub-menu"><a href="javascript:;"> <i
							class="fa fa-desktop"></i> <span>${c.name }</span>
					</a>
						<ul class="sub">
					<c:forEach items="${c.subCategories }" var="sc">
							<li><a href="general.html">${sc.name }</a></li>
					</c:forEach>
						</ul>
						...
						<div class="row mt">
							...
							<div class="col-md-4 col-sm-4 mb">
								<div class="white-panel pn">
									...
									<div class="centered">
										<img
											src="${pageContext.request.contextPath}/assets/img/product.png"
											width="120">
									</div>
								</div>
							</div>
							...
							<div class="col-md-4 mb">
								...
								<div class="white-panel pn">
									...
									<p>
										<img
											src="${pageContext.request.contextPath}/assets/img/ui-zac.jpg"
      ...
      *********************************************************************************************************************************************************** -->
					...
					<div class="col-lg-3 ds">
						...
						<div class="desc">
							<div class="thumb">
								<img class="img-circle"
									src="${pageContext.request.contextPath}/assets/img/ui-divya.jpg"
						...
						<div class="desc">
							<div class="thumb">
								<img class="img-circle"
									src="${pageContext.request.contextPath}/assets/img/ui-sherman.jpg"
									width="35px" height="35px" align="">
							</div>
							<div class="details">
								<p>
						...
						<div class="desc">
							<div class="thumb">
								<img class="img-circle"
									src="${pageContext.request.contextPath}/assets/img/ui-danro.jpg"
									width="35px" height="35px" align="">
							</div>
							<div class="details">
								<p>
		...
		<footer class="site-footer">
			<div class="text-center">
				2017-12 <a href="${pageContext.request.contextPath}" class="go-top">
	...
	<script type="text/javascript">
			 $(document).ready(function(){
				appendMenu("aaa","#","sub-menu","fa fa-cogs");
				appendSubMenu("aaa","sub",["aaa","bbb"],["#","#"]);
			});
			function appendMenu(name,url,liclass,iclass){
				$("#nav-accordion").append("<li id='"+name.replace(" ","_")+"' class='"+liclass+"'><a href='"+url+"'> <i  class='"+iclass+"'></i> <span>"+name+"</span> </a></li>");
			}
			function appendSubMenu(id,cls,names,urls){
				var elements = "<ul class='"+cls+"'>";
				for(i in names){
					elements = elements+ "<li><a  href='"+urls[i]+"'>"+names[i]+"</a></li>";
				}
